...
export const TRANSLATIONS: Record<"en" | "sq", TranslationSet> = {
  en: {
    ...
    subtitle: "For years, Pro Pizza has been the choice of thousands of customers seeking quality, taste, and reliability. Every product is prepared with care using selected beef and chicken, ensuring freshness and flavor in every single bite.",
    orderNow: "Order Now & Choose Menu",
    viewDirections: "See Location & Directions",
    ourMenu: "Pro Pizza Menu",
    menuSubtitle: "Crispy Crafted Pizzas, Pizza Dough Sandwiches, and Icy Refreshments.",
    ...
    sandwichSection: "Pizza Dough Sandwiches 🥪",
  ...
  sq: {
    ...
    subtitle: "Prej vitesh, Pro Pizza është zgjedhja e mijëra klientëve që kërkojnë cilësi, shije dhe korrektësi. Çdo produkt përgatitet me kujdes duke përdorur mish viçi dhe pule të përzgjedhur, për të garantuar freski dhe shije në çdo kafshatë.",
    orderNow: "Porosit Tani dhe Shiko Menunë",
    viewDirections: "Shiko Adresën dhe Drejtimet",
    ourMenu: "Menuja e Pro Pizza",
    menuSubtitle: "Pica të Shijshme me Brumë Special, Sanduiçë me Brumë Pice dhe Pije të Ftohta.",
    popular: "E Preferuar",
    price: "Çmimi",
    sizeMedium: "E Mesme",
    ...
    sandwichSection: "Sanduiç me Brumë Pice 🥪",
